...
//   //! Change this to RouteName.onBoarding to see the onboarding screen
...
//   if (location.startsWith(RouteName.home)) return 0;
//   if (location.startsWith(RouteName.tasks)) return 1;
//   if (location.startsWith(RouteName.teams)) return 2;
